...
class Age_Model():
    ...
    def predict_age(self, face_image):
        image_preprocessing = self.transform_face_array2age_face(face_image)
        age_predictions = self.model.predict(image_preprocessing)[0, :]
    ...
    def loadModel(self):
        ...
        home = str(Path.home())
        if not os.path.isfile(os.path.join(r"C:\Users\Sahil\Downloads\age_model_weights.h5")):
        ...
        age_model.load_weights(os.path.join(r"C:\Users\Sahil\Downloads\age_model_weights.h5"))
        return age_model
